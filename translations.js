const translations = {
    es: {
        ...
        "chat_pide_problema": "¡Entendido: {service}! Para brindarte un servicio más profesional, ¿podrías explicarnos brevemente cuál es el problema o qué necesitas que hagamos?",
        ...
        "chat_pide_camaras": "¡Entendido: cámaras! Dime qué tipo de servicio necesitas: <strong>circuito cerrado</strong> (CCTV), cámaras <strong>wifi</strong>, <strong>limpieza</strong>, <strong>mantenimiento</strong> o <strong>revisión</strong> técnica.",
        "chat_error_camaras": "Por favor especifica un servicio válido: circuito cerrado, wifi, limpieza, mantenimiento o revisión.",
        "chat_pide_cantidad_camaras": "¿Cuántas cámaras son en total?",
    ...
    en: {
        ...
        "chat_pide_problema": "Got it: {service}! To provide you with a more professional service, could you briefly explain what the problem is or what you need us to do?",
        ...
        "chat_pide_camaras": "Got it: cameras! Tell me what type of service you need: <strong>CCTV</strong> (closed circuit), <strong>WiFi</strong> cameras, <strong>cleaning</strong>, <strong>maintenance</strong>, or technical <strong>review</strong>.",
        "chat_error_camaras": "Please specify a valid service: CCTV, wifi, cleaning, maintenance, or review.",
        "chat_pide_cantidad_camaras": "How many cameras are there in total?",
